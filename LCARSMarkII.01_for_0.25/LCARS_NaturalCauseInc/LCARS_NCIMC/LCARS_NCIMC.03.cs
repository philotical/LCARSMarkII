...
#region Requirements
                 ...
                 if (formtoggle_requirements)
                 {
                    ...
                    if (group_selected.Length < 1)
                    {
                        ...
                        if (GUILayout.Button("Naturals")) { group_selected = "naturals"; current_list = LCARS_NCI.Instance.Data.Naturals_List; }
                        if (GUILayout.Button("Hostiles")) { group_selected = "mines"; current_list = LCARS_NCI.Instance.Data.Mines_List; }
                        if (GUILayout.Button("Stations")) { group_selected = "stations"; current_list = LCARS_NCI.Instance.Data.Stations_List; }
                        GUILayout.EndHorizontal();
