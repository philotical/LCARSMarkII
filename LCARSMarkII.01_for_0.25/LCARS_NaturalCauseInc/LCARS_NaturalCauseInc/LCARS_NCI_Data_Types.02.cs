...
namespace LCARSMarkII
{
    ...
    public class LCARS_NCI_Personalities
    {
        ...
        public void init()
        {
            ...
            P = new LCARS_NCI_Personality();
            P.name = "Conud'Baah";
            P.description = "He is a Kergon Trader known for eating the heart of his enemys";
            P.idcode = "conudbaah";
            ...
            P = new LCARS_NCI_Personality();
            P.name = "Krol'Laackz";
            P.description = "He is a Kerengy Trader known for owning a private moon";
            P.idcode = "krollaackz";
            P.portrait = "LCARS_NaturalCauseInc/NCIAssets/Icons/NCIPersonality_" + P.idcode;
            addPersonality(P);
            ...
            P = new LCARS_NCI_Personality();
            P.name = "Kuark";
            P.description = "He is a Kerengy Trader and owns a bar";
            P.idcode = "kuark";
            P.portrait = "LCARS_NaturalCauseInc/NCIAssets/Icons/NCIPersonality_" + P.idcode;
            addPersonality(P);
    ...
    public class LCARS_NCI_Artefacts
    {
        ...
        public void init()
        {
            ...
            P = new LCARS_NCI_InventoryItem_Type();
            P.name = "IsoLinear Controler Beta";
            P.description = "This Chip grants access to certain Equippment or Information";
            P.idcode = "IsoLinearControlerBeta";
            P.icon = "LCARS_NaturalCauseInc/NCIAssets/Icons/NCIArtefact_" + P.idcode;
            P.isDamagable = "False";
            P.integrity = "";
            P.usage_amount = "-1";
            ...
            P = new LCARS_NCI_InventoryItem_Type();
            P.name = "IsoLinear Controler Gamma";
            P.description = "This Chip grants access to certain Equippment or Information";
            P.idcode = "IsoLinearControlerGamma";
            P.icon = "LCARS_NaturalCauseInc/NCIAssets/Icons/NCIArtefact_" + P.idcode;
            P.isDamagable = "False";
            P.integrity = "";
            P.usage_amount = "-1";
    ...
    public class LCARS_NCI_Object
    {
        ...
        public void assignMission(LCARS_NCI_Mission mission_to_assign)
        {
            UnityEngine.Debug.Log("### LCARS_NCI_Object assignMission begin ");
            if (!this.missions.ContainsKey(mission_to_assign.filename))
            {
                UnityEngine.Debug.Log("### LCARS_NCI_Object assignMission requirements.list=>assigned_sfs_object_Guid=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.requirements.list[mission_to_assign.steps[1].requirementPart_id].assigned_sfs_object_Guid);
    ...
    public class LCARS_NCI_Object_assigned_missions
    {
        ...
        public bool checkCondition(LCARS_NCI_Object_assigned_missions this_aM)
        {
            ...
            UnityEngine.Debug.Log("### LCARS_NCI_Object_assigned_missions checkCondition " + this_condition_type + " than " + this_condition_distance + " related to " + this_condition_part + " - " + this_condition_egg + " todo");
            ...
            switch (this_condition_type)
            {
                ...
                case "distanceLower":
                    UnityEngine.Debug.Log("### LCARS_NCI_Object_assigned_missions checkCondition distanceLower");
                ...
                case "distanceGreater":
                    UnityEngine.Debug.Log("### LCARS_NCI_Object_assigned_missions checkCondition distanceGreater");
                    messure_point = Vector3.zero;
                    foreach (Vessel v in FlightGlobals.Vessels)
                    {
                        if (messure_point != Vector3.zero)
                        ...
                        if (this_assigned_sfs_object_Guid == v.id)
                        {
                            ...
                            {
                                messure_point = tmp.transform.position;
                                UnityEngine.Debug.Log("### LCARS_NCI_Object_assigned_missions checkCondition distanceGreater was found: " + this_condition_egg + " at " + this_condition_part);
                            }
                            else
                            {
                                UnityEngine.Debug.Log("### LCARS_NCI_Object_assigned_missions checkCondition distanceGreater was found: this_condition_part=" + this_condition_part);
                                messure_point = v.transform.position;
                            }
                        }
                    }
