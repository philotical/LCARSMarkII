...
namespace LCARSMarkII
{
    public class LCARS_BridgeProp
    {
        ...
        public void setVessel(Vessel _thisVessel)
        {
            ...
            if (LCARS == null)
            {
                UnityEngine.Debug.Log("LCARS_BridgeProp setVessel");
                try
                {
                ...
                {
                    UnityEngine.Debug.Log("LCARS_BridgeProp setVessel: LCARSRef ex=" + ex);
                }
            }
        ...
        public void setShipSystemID(string _ShipSystemID)
        {
            ...
            {
                UnityEngine.Debug.Log("LCARS_BridgeProp setShipSystemID _ShipSystemID=" + _ShipSystemID);
        ...
        public void setGameObjectLocation(Transform _GameObjectLocation)
        {
            ...
            {
                UnityEngine.Debug.Log("LCARS_BridgeProp setGameObjectLocation attempt to register GameObjectLocation ");
                GameObjectLocation = _GameObjectLocation;
            }
        }
        public void setActivationDistance(float _ActivationDistance)
        {
            //UnityEngine.Debug.Log("LCARS_BridgeProp setActivationDistance attempt to register ActivationDistance ");
        ...
        {
            //UnityEngine.Debug.Log("LCARS_BridgeProp FixedUpdate 1 ");
            if (GameObjectLocation == null)
            {
                return;
            }
            //UnityEngine.Debug.Log("LCARS_BridgeProp FixedUpdate 2 ");
            if (FlightGlobals.ActiveVessel.vesselType != VesselType.EVA)
            {
                return;
            }
            //UnityEngine.Debug.Log("LCARS_BridgeProp FixedUpdate 3 ");
            ...
            //UnityEngine.Debug.Log("LCARS_BridgeProp FixedUpdate 4 ");
            if (LCARS == null)
            {
                return;
            }
            LCARS.WindowState_bypass = false;
            //UnityEngine.Debug.Log("LCARS_BridgeProp FixedUpdate 5 ");
            ...
            //UnityEngine.Debug.Log("LCARS_BridgeProp FixedUpdate attempt to messure ActivationDistance dist=" + dist);
            if (dist < 1f)
            {
                if (!sound1_was_played)
                {
                    ...
                    LCARS.lWindows.setWindowState("Bridge", true);
