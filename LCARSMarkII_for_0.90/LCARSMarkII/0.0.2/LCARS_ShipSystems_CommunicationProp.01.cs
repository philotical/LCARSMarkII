...
{
    public class LCARS_CommunicationProp
    {
        ...
        public void setVessel(Vessel _thisVessel)
        {
            ...
            if (LCARS == null)
            {
                UnityEngine.Debug.Log("LCARS_CommunicationProp setVessel");
                try
                {
                ...
                {
                    UnityEngine.Debug.Log("LCARS_CommunicationProp setVessel: LCARSRef ex=" + ex);
                }
            }
        ...
        public void setShipSystemID(string _ShipSystemID)
        {
            ...
            {
                UnityEngine.Debug.Log("LCARS_CommunicationProp setShipSystemID _ShipSystemID=" + _ShipSystemID);
        ...
        public void setGameObjectLocation(Transform _GameObjectLocation)
        {
            ...
            {
                UnityEngine.Debug.Log("LCARS_CommunicationProp setGameObjectLocation attempt to register GameObjectLocation ");
                GameObjectLocation = _GameObjectLocation;
            }
        }
        public void setActivationDistance(float _ActivationDistance)
        {
            //UnityEngine.Debug.Log("LCARS_CommunicationProp setActivationDistance attempt to register ActivationDistance ");
        ...
        {
            //UnityEngine.Debug.Log("LCARS_CommunicationProp FixedUpdate 1 ");
            if (GameObjectLocation == null)
            {
                return;
            }
            //UnityEngine.Debug.Log("LCARS_CommunicationProp FixedUpdate 2 ");
            if (FlightGlobals.ActiveVessel.vesselType != VesselType.EVA)
            {
                return;
            }
            //UnityEngine.Debug.Log("LCARS_CommunicationProp FixedUpdate 3 ");
            ...
            //UnityEngine.Debug.Log("LCARS_CommunicationProp FixedUpdate 4 ");
            if (LCARS == null)
            {
                return;
            }
            LCARS.WindowState_bypass = false;
            //UnityEngine.Debug.Log("LCARS_CommunicationProp FixedUpdate 5 ");
            ...
            //UnityEngine.Debug.Log("LCARS_CommunicationProp FixedUpdate attempt to messure ActivationDistance dist=" + dist);
            if (dist < 1f)
            {
