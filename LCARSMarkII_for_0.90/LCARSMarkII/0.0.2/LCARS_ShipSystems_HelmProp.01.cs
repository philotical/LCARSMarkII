...
namespace LCARSMarkII
{
    public class LCARS_HelmProp
    {
        ...
        public void setVessel(Vessel _thisVessel)
        {
            ...
            if (LCARS == null)
            {
                UnityEngine.Debug.Log("LCARS_HelmProp setVessel");
                try
                {
                ...
                {
                    UnityEngine.Debug.Log("LCARS_HelmProp setVessel: LCARSRef ex=" + ex);
                }
            }
        ...
        public void setShipSystemID(string _ShipSystemID)
        {
            ...
            {
                UnityEngine.Debug.Log("LCARS_HelmProp setShipSystemID _ShipSystemID=" + _ShipSystemID);
        ...
        public void setGameObjectLocation(Transform _GameObjectLocation)
        {
            ...
            {
                UnityEngine.Debug.Log("LCARS_HelmProp setGameObjectLocation attempt to register GameObjectLocation ");
                GameObjectLocation = _GameObjectLocation;
            }
        }
        public void setActivationDistance(float _ActivationDistance)
        {
            //UnityEngine.Debug.Log("LCARS_HelmProp setActivationDistance attempt to register ActivationDistance ");
        ...
        {
            //UnityEngine.Debug.Log("LCARS_HelmProp FixedUpdate 1 ");
            if (GameObjectLocation == null)
            {
                return;
            }
            //UnityEngine.Debug.Log("LCARS_HelmProp FixedUpdate 2 ");
            if (FlightGlobals.ActiveVessel.vesselType != VesselType.EVA)
            {
                return;
            }
            //UnityEngine.Debug.Log("LCARS_HelmProp FixedUpdate 3 ");
            ...
            //UnityEngine.Debug.Log("LCARS_HelmProp FixedUpdate 4 ");
            if (LCARS == null)
            {
                return;
            }
            LCARS.WindowState_bypass = false;
            //UnityEngine.Debug.Log("LCARS_HelmProp FixedUpdate 5 ");
            ...
            //UnityEngine.Debug.Log("LCARS_HelmProp FixedUpdate attempt to messure ActivationDistance dist=" + dist);
            if (dist < 1f)
            {
                if (!sound1_was_played)
                {
                    ...
                    LCARS.lWindows.setWindowState("Helm", true);
            ...
            else
            {
                ...
                {
                    try { 
                        //LCARS.lAudio.play("LCARS_SubsystemClose", GameObjectLocation.gameObject); 
                    }
                    catch (Exception ex) { }
