...
{
    public class LCARS_TacticalProp
    {
        ...
        public void setVessel(Vessel _thisVessel)
        {
            ...
            if (LCARS == null)
            {
                UnityEngine.Debug.Log("LCARS_TacticalProp setVessel");
                try
                {
                ...
                {
                    UnityEngine.Debug.Log("LCARS_TacticalProp setVessel: LCARSRef ex=" + ex);
                }
            }
        ...
        public void setShipSystemID(string _ShipSystemID)
        {
            ...
            {
                UnityEngine.Debug.Log("LCARS_TacticalProp setShipSystemID _ShipSystemID=" + _ShipSystemID);
        ...
        public void setGameObjectLocation(Transform _GameObjectLocation)
        {
            ...
            {
                UnityEngine.Debug.Log("LCARS_TacticalProp setGameObjectLocation attempt to register GameObjectLocation ");
                GameObjectLocation = _GameObjectLocation;
            }
        }
        public void setActivationDistance(float _ActivationDistance)
        {
            //UnityEngine.Debug.Log("LCARS_TacticalProp setActivationDistance attempt to register ActivationDistance ");
        ...
        {
            //UnityEngine.Debug.Log("LCARS_TacticalProp FixedUpdate 1 ");
            if (GameObjectLocation == null)
            {
                return;
            }
            //UnityEngine.Debug.Log("LCARS_TacticalProp FixedUpdate 2 ");
            if (FlightGlobals.ActiveVessel.vesselType != VesselType.EVA)
            {
                return;
            }
            //UnityEngine.Debug.Log("LCARS_TacticalProp FixedUpdate 3 ");
            ...
            //UnityEngine.Debug.Log("LCARS_TacticalProp FixedUpdate 4 ");
            if (LCARS == null)
            {
                return;
            }
            LCARS.WindowState_bypass = false;
            //UnityEngine.Debug.Log("LCARS_TacticalProp FixedUpdate 5 ");
            ...
            //UnityEngine.Debug.Log("LCARS_TacticalProp FixedUpdate attempt to messure ActivationDistance dist=" + dist);
            if (dist < 1f)
            {
                if (!sound1_was_played)
                {
                    ...
                    LCARS.lWindows.setWindowState("Tactical", true);
