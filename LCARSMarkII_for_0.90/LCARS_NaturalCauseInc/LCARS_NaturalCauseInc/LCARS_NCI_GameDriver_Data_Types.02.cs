...
namespace LCARSMarkII
{
    public static class LCARS_NCI_Mission_Archive_Tools
    {
        ...
        public static string TaskStringConstructor_Steps(LCARS_NCI_Mission_Archive_RunningMission m)
        {
            ...
            if (m.RunningStep.missionStep.locationtype == "distanceLower" || m.RunningStep.missionStep.locationtype == "distanceGreater")
            {
                ...
                if (m.RunningStep.missionStep.location_PQSCity != "")
                {
                    task = task + m.RunningStep.missionStep.location_PQSCity + " on ";
                }
                if (m.RunningStep.missionStep.location_body != "")
                {
                    task = task + m.RunningStep.missionStep.location_body;
                }
            }
            return task;
        }
        ...
        {
            string task = "";
            if (LCARS_NCI_Mission_Archive_Tools.get_current_jobID() == 0)
            {
                task = LCARS_NCI_Mission_Archive_Tools.TaskStringConstructor_Steps(m);
            }
            ...
            if (m.RunningStep.RunningJob.missionJob.target == "object" || m.RunningStep.RunningJob.missionJob.target == "egg")
            {
                if (m.RunningStep.RunningJob.missionJob.jobtype == "distanceLower" || m.RunningStep.RunningJob.missionJob.jobtype == "distanceGreater")
                {
                    ...
                    {
                        task = "Get closer than " + m.RunningStep.RunningJob.missionJob.distance + " meter to ";
                    }
                    if (m.RunningStep.RunningJob.missionJob.jobtype == "distanceGreater")
                    {
                        task = "Get farther away than " + m.RunningStep.RunningJob.missionJob.distance + " meter from ";
                    }
                    ...
                    if (m.RunningStep.RunningJob.missionJob.NCI_PQSCity != "")
                    {
                        task = task + m.RunningStep.RunningJob.missionJob.NCI_PQSCity + " on ";
                    }
                    if (m.RunningStep.RunningJob.missionJob.NCI_body != "")
                    {
                        task = task + m.RunningStep.RunningJob.missionJob.NCI_body;
                    }
                }
                ...
                {
                    task = "Get closer than " + m.RunningStep.RunningJob.missionJob.distance + " meter to the object " + m.RunningStep.RunningJob.missionJob.NCI_object + " and perform a detailed scan";
                }
            }
        ...
        public static int get_current_stepID()
        {
            ...
            try { sID = LCARS_NCI.Instance.Data.MissionArchive.RunningMission.get_currentStep(); }
            catch { }
            return sID;
        }
        ...
        public static int get_current_jobID()
        {
            ...
            try { jID = LCARS_NCI.Instance.Data.MissionArchive.RunningMission.get_currentJob(); }
            catch { }
            return jID;
        }

        public static bool checkCondition_Step(int stepID, LCARS_NCI_Mission mission)
        {
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Step");
            ...
            try { this_condition_type = (mission.steps[stepID].locationtype == null) ? "" : mission.steps[stepID].locationtype; }catch { }
            try { this_condition_distance = (mission.steps[stepID].location_distance == null) ? "" : mission.steps[stepID].location_distance; }catch { }
            try { requirement_id = (mission.steps[stepID].requirementPart_id == null) ? 0 : mission.steps[stepID].requirementPart_id; }catch { }
            try { this_condition_part = (mission.steps[stepID].location_part == null) ? "" : mission.steps[stepID].location_part; }catch { }
            try { this_condition_egg = (mission.steps[stepID].location_egg == null) ? "" : mission.steps[stepID].location_egg; }catch { }
            try { this_condition_body = (mission.steps[stepID].location_body == null) ? "" : mission.steps[stepID].location_body; }catch { }
            try { this_condition_PQSCity = (mission.steps[stepID].location_PQSCity == null) ? "" : mission.steps[stepID].location_PQSCity; }catch { }

            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Step stepID=" + stepID);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Step this_condition_type=" + this_condition_type);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Step this_condition_distance=" + this_condition_distance);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Step requirement_id=" + requirement_id);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Step this_condition_part=" + this_condition_part);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Step this_condition_egg=" + this_condition_egg);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Step this_condition_body=" + this_condition_body);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Step this_condition_PQSCity=" + this_condition_PQSCity);

            return checkCondition_distance(this_condition_type, this_condition_distance, requirement_id, this_condition_part, this_condition_egg, this_condition_body, this_condition_PQSCity, mission);
        }
        public static bool checkCondition_Distance_Job(int stepID, int jobID, LCARS_NCI_Mission mission)
        {
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Distance_Job");
            string this_condition_type = "";
            string this_condition_distance = "";
            int requirement_id = 0;
            string this_condition_part = "";
            ...
            try { this_condition_type = (mission.steps[stepID].Jobs.jobList[jobID].jobtype == null) ? "" : mission.steps[stepID].Jobs.jobList[jobID].jobtype; }catch { }
            try { this_condition_distance = (mission.steps[stepID].Jobs.jobList[jobID].distance == null) ? "" : mission.steps[stepID].Jobs.jobList[jobID].distance; }catch { }
            try { requirement_id = (mission.steps[stepID].Jobs.jobList[jobID].requirement_id == null) ? 0 : mission.steps[stepID].Jobs.jobList[jobID].requirement_id; }catch { }
            try { this_condition_part = (mission.steps[stepID].Jobs.jobList[jobID].NCI_object == null) ? "" : mission.steps[stepID].Jobs.jobList[jobID].NCI_object; }catch { }
            try { this_condition_egg = (mission.steps[stepID].Jobs.jobList[jobID].NCI_egg == null) ? "" : mission.steps[stepID].Jobs.jobList[jobID].NCI_egg; }catch { }
            try { this_condition_body = (mission.steps[stepID].Jobs.jobList[jobID].NCI_body == null) ? "" : mission.steps[stepID].Jobs.jobList[jobID].NCI_body; }catch { }
            try { this_condition_PQSCity = (mission.steps[stepID].Jobs.jobList[jobID].NCI_PQSCity == null) ? "" : mission.steps[stepID].Jobs.jobList[jobID].NCI_PQSCity; }catch { }

            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Step stepID=" + stepID);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Step jobID=" + jobID);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Distance_Job this_condition_type=" + this_condition_type);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Distance_Job this_condition_distance=" + this_condition_distance);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Distance_Job requirement_id=" + requirement_id);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Distance_Job this_condition_part=" + this_condition_part);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Distance_Job this_condition_egg=" + this_condition_egg);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Distance_Job this_condition_body=" + this_condition_body);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_Distance_Job this_condition_PQSCity=" + this_condition_PQSCity);

            
            if (this_condition_type == "distanceLower" || this_condition_type == "distanceGreater")
            {
                return checkCondition_distance(this_condition_type, this_condition_distance, requirement_id, this_condition_part, this_condition_egg, this_condition_body, this_condition_PQSCity, mission);
            }
            return false;
        }
        private static bool checkCondition_distance(string this_condition_type, string this_condition_distance, int requirement_id, string this_condition_part, string this_condition_egg, string this_condition_body, string this_condition_PQSCity, LCARS_NCI_Mission mission)
        {
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance");
        /*
            Vector3 messure_point = Vector3.zero;

            if (requirement_id == 0)
            {
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance requirement_id == 0 skipping");
                return false;
            }


            LCARS_NCI_Mission_Requirement mR = null;
            if (mission.requirements.list.ContainsKey(requirement_id))
            {
                mR = mission.requirements.list[requirement_id];
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance " + this_condition_type + " mR mR.id=" + mR.id);
            }
            else
            {
                mR = null;
            ...
            if (mR == null)
            {
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " mR==null skipping");
                return false;
            }

            Guid this_assigned_sfs_object_Guid = mR.assigned_sfs_object_Guid;

            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance alpha " + this_condition_type + " than " + this_condition_distance + " related to part=" + this_condition_part + "  body=" + this_condition_body + " PQSCity=" + this_condition_PQSCity + " egg=" + this_condition_egg + " this_assigned_sfs_object_Guid=" + this_assigned_sfs_object_Guid);
            ...
            switch (this_condition_type)
            {
                ...
                case "distanceGreater":
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance " + this_condition_type);
                    ...
                    try
                    {
                        if (this_condition_body != "")
                        {
                            ...
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance StepBody.name=" + StepBody.name);
                        }
                    }catch { }
                    try
                    {
                        if (this_condition_body != "" && this_condition_PQSCity != "" && this_condition_egg != "")
                        {
                            objectType = "PlanetaryLocation";
                        }
                    }catch { }
                    try
                    {
                        if (this_condition_part != "" && this_condition_egg == "")
                        {
                            objectType = "VesselObject";
                        }
                    }catch { }
                    try
                    {
                        if (this_condition_part != "" && this_condition_egg != "")
                        {
                            objectType = "VesselActionPoint";
                        }
                    }catch { }

                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance objectType=" + objectType);
                    ...
                    switch (objectType)
                    {
                        ...
                        case"CelestialBody":
                            ...
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance was found: " + this_condition_body);
                            break;
                    
                        case"PlanetaryLocation":
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance PlanetaryLocation begin ");
                            ...
                            if (this_condition_egg != "")
                            {
                                ...
                                foreach (KeyValuePair<string, GameObject> pair in NCIScanGOExtensions.ActionPointsGameObjects)
                                {
                                    ...
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance PlanetaryLocation 4 ActionPointsGameObjects name=" + name + " this_condition_egg=" + this_condition_egg);
                            ...
                            if (tmp != null)
                            {
                                ...
                                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance PlanetaryLocation 10 was found: " + this_condition_egg + " at " + this_condition_PQSCity + " on " + this_condition_body);
                            }
                            else
                            {
                                messure_point = StepBody.transform.position;
                                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance PlanetaryLocation 11 was found: " + this_condition_body);
                            }
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance PlanetaryLocation done ");
                            break;
                        ...
                        case"VesselObject":
                            foreach (Vessel v in FlightGlobals.Vessels)
                            {
                                ...
                                { continue; }
                                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance distanceLower 1 => this_assigned_sfs_object_Guid=" + this_assigned_sfs_object_Guid + " v.id=" + v.id);
                                if (this_assigned_sfs_object_Guid == v.id)
                                {
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance distanceLower 2 => this_assigned_sfs_object_Guid=" + this_assigned_sfs_object_Guid + " v.id=" + v.id);
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance distanceLower was found: this_condition_part=" + this_condition_part);
                                    messure_point = v.transform.position;
                                }
                            }
                            break;
                    
                        case"VesselActionPoint":
                            foreach (Vessel v in FlightGlobals.Vessels)
                            {
                                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance messure_point=" + messure_point.ToString());
                                if (messure_point != Vector3.zero)
                                { continue; }
                                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance distanceLower 1 => this_assigned_sfs_object_Guid=" + this_assigned_sfs_object_Guid + " v.id=" + v.id);
                                if (this_assigned_sfs_object_Guid == v.id)
                                {
                                    ...
                                    if (tmp != null)
                                    {
                                        ...
                                        UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance distanceLower was found: " + this_condition_egg + " at " + this_condition_part);
                                    }
                                    else
                                    {
                                        UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance distanceLower was found: this_condition_part=" + this_condition_part);
                    ...
                    */
            GameObject go_in_question = null;
            try
            {
                go_in_question = LCARS_NCI_Mission_Archive_Tools.identify_gameObject(requirement_id, this_condition_part, this_condition_egg, this_condition_body, this_condition_PQSCity, mission);
            }
            catch { return false; }

            Vector3 messure_point = Vector3.zero;
            messure_point = go_in_question.transform.position;

            if (messure_point == Vector3.zero) { UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance messure_point == Vector3.zero skipping"); return false; }
            ...
            if (this_condition_type == "distanceLower")
            {
                ...
                {
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance distanceLower was met: this_condition_distance=" + this_condition_distance);
                    return true;
                }
                else
                {
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance distanceLower was NOT met: this_condition_distance=" + this_condition_distance);
                }
            }
            if (this_condition_type == "distanceGreater")
            {
                ...
                {
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance distanceGreater was met: this_condition_distance=" + this_condition_distance);
                    return true;
                }
                else
                {
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.checkCondition_distance distanceGreater was NOT met: this_condition_distance=" + this_condition_distance);
                }
            }

            return false;
        }
        public static GameObject identify_gameObject(int requirement_id, string this_condition_part, string this_condition_egg, string this_condition_body, string this_condition_PQSCity, LCARS_NCI_Mission mission)
        {
            if (requirement_id == 0)
            {
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject requirement_id == 0 skipping");
                return null;
            }
            ...
            {
                mR = mission.requirements.list[requirement_id];
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject mR.id=" + mR.id);
            }
            else
            {
                mR = null;
            ...
            if (mR == null)
            {
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " mR==null skipping");
                return null;
            }
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject mR.bodyname=" + mR.bodyname + " mR.egg_idcode=" + mR.egg_idcode + " mR.part_idcode=" + mR.part_idcode);
            Guid this_assigned_sfs_object_Guid = mR.assigned_sfs_object_Guid;

            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject alpha  related to part=" + this_condition_part + "  body=" + this_condition_body + " PQSCity=" + this_condition_PQSCity + " egg=" + this_condition_egg + " this_assigned_sfs_object_Guid=" + this_assigned_sfs_object_Guid);
            ...
            try
            {
                if (this_condition_body != "")
                {
                    ...
                    if (StepBody == null)
                    {
                        UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject StepBody == null skipping ");
                        return null;
                    }
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject StepBody.name=" + StepBody.name);
                }
            }
            catch { }
            try
            ...
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject objectType=" + objectType);

            switch (objectType)
            {

                case "CelestialBody":
                    return StepBody.gameObject;
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject was found: " + this_condition_body);
                    break;

                case "PlanetaryLocation":
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject PlanetaryLocation begin ");
                    NCIScanGOExtensions.FilterChildGameObjects(StepBody.gameObject, this_condition_PQSCity);
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject PlanetaryLocation 1 ");
                    if (this_condition_egg != "")
                    {
                        UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject PlanetaryLocation 2 ");
                        foreach (KeyValuePair<string, GameObject> pair in NCIScanGOExtensions.ActionPointsGameObjects)
                        {
                            //UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject PlanetaryLocation 3 ");
                            string name = pair.Value.name;
                            //UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject PlanetaryLocation 4 ActionPointsGameObjects name=" + name + " this_condition_egg=" + this_condition_egg);
                            if (name == this_condition_egg)
                            {
                                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject PlanetaryLocation 5 ActionPointsGameObjects found egg");
                                GameObject go = pair.Value;
                                tmp = go.transform;
                                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject PlanetaryLocation 6 ");
                            }
                            //UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject PlanetaryLocation 7 ");
                        }
                        UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject PlanetaryLocation 8 ");
                    }
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject PlanetaryLocation 9 ");
                    if (tmp != null)
                    {
                        return tmp.gameObject;
                        UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject PlanetaryLocation 10 was found: " + this_condition_egg + " at " + this_condition_PQSCity + " on " + this_condition_body);
                    }
                    else
                    {
                        return StepBody.gameObject;
                        UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject PlanetaryLocation 11 was found: " + this_condition_body);
                    }
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject PlanetaryLocation done ");
                    break;

                case "VesselObject":
                    foreach (Vessel v in FlightGlobals.Vessels)
                    {
                        UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject 1 => this_assigned_sfs_object_Guid=" + this_assigned_sfs_object_Guid + " v.id=" + v.id);
                        if (this_assigned_sfs_object_Guid == v.id)
                        {
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject 2 => this_assigned_sfs_object_Guid=" + this_assigned_sfs_object_Guid + " v.id=" + v.id);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject was found: this_condition_part=" + this_condition_part);
                            return v.gameObject;
                        }
                    }
                    break;
                ...
                case "VesselActionPoint":
                    foreach (Vessel v in FlightGlobals.Vessels)
                    {
                        ...
                        if (this_assigned_sfs_object_Guid == v.id)
                        {
                            ...
                            {
                                return tmp.gameObject;
                                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject was found: " + this_condition_egg + " at " + this_condition_part);
                            }
                            else
                            {
                                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_Tools.identify_gameObject was found: this_condition_part=" + this_condition_part);
    ...
    public class LCARS_NCI_Mission_Archive
    {
        ...
        private float ObserveBackgroundMissions_lastUpdate = 0.0f;
        private float ObserveBackgroundMissions_lastFixedUpdate = 0.0f;
        //private private float lastflyUpdate = 0.0f;
        private float ObserveBackgroundMissions_logInterval = 1.0f;
        public void ObserveBackgroundMissions()
        {

            if ((Time.time - ObserveBackgroundMissions_lastFixedUpdate) < ObserveBackgroundMissions_logInterval)
            {
                return;
            }
            ObserveBackgroundMissions_lastFixedUpdate = Time.time;
            ...
            foreach (KeyValuePair<Guid,LCARS_NCI_Object> pair in LCARS_NCI.Instance.Data.sfs_ActiveObjectsList)
            {
               UnityEngine.Debug.Log("### ObserveBackgroundMissions 3 ");
                ...
                if (O.bodyname != "" && O.bodyname!=null)
                {
                    foreach (CelestialBody CB in FlightGlobals.Bodies)
                    {
                        if (O.bodyname == CB.name)
                        {
                ...
                */
                ...
                foreach (string key in O.missions.Keys)
                {
                    if (O.bodyname == "" && O.partname == "")
                    {
                        continue;
                    }
                    LCARS_NCI_Object_assigned_missions aM = O.missions[key];
                    //if (aM.mission_id==null)
                    //{continue;}
                    ...
                    if (LCARS_NCI.Instance.Data.sfs_ActiveObjectsList[GID].missionStack.First.Value == aM.mission_id)
                    {
                       UnityEngine.Debug.Log("### ObserveBackgroundMissions 6 first stack item found =" + LCARS_NCI.Instance.Data.sfs_ActiveObjectsList[GID].missionStack.First.Value);
                        ...
                        UnityEngine.Debug.Log("### ObserveBackgroundMissions 7 aM.mission_id=" + aM.mission_id + " aM.condition_part=" + aM.condition_part + " aM.assigned_sfs_object_Guid=" + aM.assigned_sfs_object_Guid);
                        //if (aM.checkCondition(aM))
                        if (LCARS_NCI_Mission_Archive_Tools.checkCondition_Step(1, aM.mission))
                        {
        ...
        public void addMission(LCARS_NCI_Mission m)
        {
            ...
            if (m.meetsRequirements())
            {
                ...
                Debug.Log("LCARS_NCI_Data LCARS_NCI_Mission_Archive addMission 12 meetsRequirements");
                    ...
                    if (m.requirements.list != null)
                    {
                        ...
                        foreach (LCARS_NCI_Mission_Requirement R in m.requirements.list.Values)
                        {
                            foreach (KeyValuePair<Guid, LCARS_NCI_Object> pair in LCARS_NCI.Instance.Data.sfs_ActiveObjectsList)
                            {
                                ...
                                if ((pair.Value.partname == R.part_idcode && m.steps[1].location_part == R.part_idcode) || (pair.Value.bodyname == R.bodyname && m.steps[1].location_body == R.bodyname))
                                {
                                    ...
                                    nAM.condition_body = m.steps[1].location_body;
                                    nAM.condition_PQSCity = m.steps[1].location_PQSCity;
                            ...
                            try
                            {
                                Debug.Log("LCARS_NCI_Data LCARS_NCI_Mission_Archive addMission 12c part_idcode ");
                                if (LCARS_NCI.Instance.Data.ObjectArchive.ContainsKey(R.part_idcode) && m.steps[1].location_part == R.part_idcode)
                                {
                                    if (LCARS_NCI.Instance.Data.ObjectArchive[R.part_idcode].missions == null && R.part_idcode != null && R.part_idcode != "")
                                    {
                                    ...
                                    Debug.Log("LCARS_NCI_Data LCARS_NCI_Mission_Archive addMission 12d R.part_idcode = " + R.part_idcode);
                                    Debug.Log("LCARS_NCI_Data LCARS_NCI_Mission_Archive addMission 12d m.title = " + m.title);
                                    Debug.Log("LCARS_NCI_Data LCARS_NCI_Mission_Archive addMission 12d m.steps[1].location_part = " + m.steps[1].location_part);
                                    LCARS_NCI.Instance.Data.ObjectArchive[R.part_idcode].assignMission(R.part_idcode, m);
                            ...
                            try
                            {
                                Debug.Log("LCARS_NCI_Data LCARS_NCI_Mission_Archive addMission 12c bodyname ");
                                if (LCARS_NCI.Instance.Data.ObjectArchive.ContainsKey(R.bodyname) && m.steps[1].location_body == R.bodyname)
                                {
                                    if (LCARS_NCI.Instance.Data.ObjectArchive[R.bodyname].missions == null && R.bodyname != null && R.bodyname != "")
                                    {
                                        LCARS_NCI.Instance.Data.ObjectArchive[R.bodyname].missions = new Dictionary<string, LCARS_NCI_Object_assigned_missions>();
                                    }
                                    Debug.Log("LCARS_NCI_Data LCARS_NCI_Mission_Archive addMission 12d ");
                                    Debug.Log("LCARS_NCI_Data LCARS_NCI_Mission_Archive addMission 12d R.bodyname = " + R.bodyname);
                                    Debug.Log("LCARS_NCI_Data LCARS_NCI_Mission_Archive addMission 12d m.title = " + m.title);
                                    Debug.Log("LCARS_NCI_Data LCARS_NCI_Mission_Archive addMission 12d m.steps[1].location_body = " + m.steps[1].location_body);
                                    LCARS_NCI.Instance.Data.ObjectArchive[R.bodyname].assignMission(R.bodyname, m);
                                    Debug.Log("LCARS_NCI_Data LCARS_NCI_Mission_Archive addMission 12e ");
                                }
                            }
                            catch { }
            ...
            if (mission.requirements.list.Count >= mission.requirements_confirmation_list.Count)
            {
                foreach (KeyValuePair<int, LCARS_NCI_Mission_Requirement> pairR in mission.requirements.list)
                {
                    ...
                    foreach (KeyValuePair<Guid, LCARS_NCI_Object> pair in LCARS_NCI.Instance.Data.sfs_ActiveObjectsList)
                    {
                        ...
                        if (O.partname == R.part_idcode || O.bodyname == R.bodyname)
                        {
                            ...
                            if (pairR.Key == mission.steps[1].requirementPart_id)
                            {
    ...
    public class LCARS_NCI_Mission_Archive_RunningMission
    {
        ...
        public int last_conversation_was_in_step = 0;
        ...
        {
            int sID = LCARS_NCI_Mission_Archive_Tools.get_current_stepID();
            int jID = LCARS_NCI_Mission_Archive_Tools.get_current_jobID();
            ...
            if ((LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.next_step == "missionEnd" && RequestedStepID == "") || RequestedStepID == "missionEnd")
            {
                ...
                try
                {
                    LCARS_NCI.Instance.Data.MissionArchive.RunningMission.progressLog.mission_end_reached = true;
                    LCARS_NCI.Instance.Data.MissionArchive.RunningMission.progressLog.saveMissionLog();
                }
                catch (Exception ex) 
                {
                    UnityEngine.Debug.Log("### Mission Log save failed ex="+ex);
                }
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.reset_mission();

                ScreenMessages.PostScreenMessage(
                   "<color=#ff9900ff>The Mission has ended" + "</color>",
           ...
           //UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningMission go_to_next_Step");
            ...
            try
            {
                ...
                else
                {
                    ...
                    LCARS_NCI.Instance.Data.MissionArchive.RunningMission.last_conversation_was_in_step = 0;
                }
            ...
            {
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningMission go_to_next_Step catch STEPERROR 1 abort mission ex=" + ex);
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.reset_mission();
                return;
                ...
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningMission go_to_next_Step catch STEPERROR test 2 1 ");
                ...
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningMission go_to_next_Step catch STEPERROR test 2 2 ");
                ...
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningMission go_to_next_Step catch STEPERROR test 2 3 ");
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningMission go_to_next_Step catch STEPERROR test 2 4 ");
                ...
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningMission go_to_next_Step catch STEPERROR test 2 5 ");
                try
                {
                    LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep = LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.steps[LCARS_NCI.Instance.Data.MissionArchive.RunningMission.get_currentStep()];
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningMission go_to_next_Step catch STEPERROR test 2 6 ");
                }
                catch { }
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.sentMessageLog = new List<string>();
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningMission go_to_next_Step catch STEPERROR test 2 7 ");
                ...
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningMission go_to_next_Step catch STEPERROR test 2 8 ");
                try
                {
                    if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningConversation.current_speechID > 0) { LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningConversation.current_speechID = 0; }
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningMission go_to_next_Step catch STEPERROR test 2 9 ");
                }
                catch{}
            ...
            {
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningMission go_to_next_Step catch STEPERROR 2 abort mission ex=" + ex);
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.reset_mission();
                return;
            ...
            {
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningMission go_to_next_Step catch STEPERROR 3 abort mission ex=" + ex);
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.reset_mission();
                return;
            ...
            try
            {
                sID = LCARS_NCI_Mission_Archive_Tools.get_current_stepID();
                jID = LCARS_NCI_Mission_Archive_Tools.get_current_jobID();
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningMission go_to_next_Step " + sID + "/" + jID + " ");
                ScreenMessages.PostScreenMessage(
                   "<color=#ff9900ff>The Chapter " + sID + " has started</color>",
                   5f, ScreenMessageStyle.UPPER_CENTER
                    );
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_conversation_done = false;
            }
            ...
            {
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningMission go_to_next_Step catch STEPERROR 4 abort mission ex=" + ex);
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.reset_mission();
                return;

            }
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningMission go_to_next_Step done " + sID + "/" + jID + " ");
        ...
        public void go_to_next_Job(int RequestedJobID = 0)
        {
            ...
            ScreenMessages.PostScreenMessage(
               "<color=#ff9900ff>The Job " + jID + " of Chapter " + sID + " has started</color>",
               5f, ScreenMessageStyle.UPPER_CENTER
           );
        ...
        public void processMission()
        {
            ...
            UnityEngine.Debug.Log("######processMission###################################################");
            ...
            try { UnityEngine.Debug.Log("### processMission RunningStep.id=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.id); }
            catch { UnityEngine.Debug.Log("### processMission RunningStep.id=ERROR"); }
            try { UnityEngine.Debug.Log("### processMission RunningMission.mission.steps.Count=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.steps.Count); }
            catch { UnityEngine.Debug.Log("### processMission RunningMission.mission.steps.Count=ERROR"); }
            try { UnityEngine.Debug.Log("### processMission RunningMission.mission.title=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.title); }
            catch { UnityEngine.Debug.Log("### processMission RunningMission.mission.title=ERROR"); }
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep RunJobs RunningMission.get_currentStep()=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.get_currentStep());
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep RunJobs RunningMission.get_currentJob()=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.get_currentJob());
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep RunJobs RunningMission.current_step=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.current_step);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep RunJobs RunningMission.current_job=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.current_job);
            try { UnityEngine.Debug.Log("### processMission RunningStep.conditionConfirmedOnce=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.conditionConfirmedOnce); }
            catch { UnityEngine.Debug.Log("### processMission RunningStep.conditionConfirmedOnce=ERROR"); }
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep RunJobs last_conversation_was_in_step=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.last_conversation_was_in_step);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep RunJobs step_conversation_done=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_conversation_done);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep RunJobs step_start_done=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_start_done);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep RunJobs step_end_reached=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_end_reached);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep RunJobs job_start_done=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.job_start_done);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep RunJobs job_end_reached=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.job_end_reached);
            UnityEngine.Debug.Log("#########################################################");

            UnityEngine.Debug.Log("LCARS_NCI_Mission_Archive_RunningMission processMission check 1");
            ...
            UnityEngine.Debug.Log("LCARS_NCI_Mission_Archive_RunningMission processMission check 2");
            try
            {
                if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.steps[LCARS_NCI.Instance.Data.MissionArchive.RunningMission.get_currentStep()] == null) { return; }
            }
            catch
            {
                UnityEngine.Debug.Log("LCARS_NCI_Mission_Archive_RunningMission processMission RunningMission.mission.steps[" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.get_currentStep() + "] failed ");
            }
            ...
            UnityEngine.Debug.Log("LCARS_NCI_Mission_Archive_RunningMission processMission check 3");
            ...
            UnityEngine.Debug.Log("LCARS_NCI_Mission_Archive_RunningMission processMission check 4");
            ...
            UnityEngine.Debug.Log("LCARS_NCI_Mission_Archive_RunningMission processMission check 5");
    ...
    public class LCARS_NCI_Mission_Archive_RunningStep
    {
        ...
        public void processStep()
        {
            ...
            try { UnityEngine.Debug.Log("### processStep RunningStep.id=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.id); }
            catch { UnityEngine.Debug.Log("### processStep RunningStep.id=ERROR"); }

            if (!LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.conditionConfirmedOnce)
            {
                //LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.checkCondition();
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.conditionConfirmedOnce = LCARS_NCI_Mission_Archive_Tools.checkCondition_Step(LCARS_NCI_Mission_Archive_Tools.get_current_stepID(), LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission);
                Debug.Log("LCARS_NCI_Mission_Archive_RunningStep processStep conditionConfirmedOnce=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.conditionConfirmedOnce);
            }
            if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.conditionConfirmedOnce)
            {
            ...
            {
                Debug.Log("LCARS_NCI_Mission_Archive_RunningStep processStep condition never confirmed, aborting ");
                return;
            }
            ...
            if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.PartOptions.Count>0)
            {
                foreach (Vessel v in FlightGlobals.Vessels)
                {
                    ...
                    foreach(LCARS_NCI_Step_Remote_PartOptions_Type pO in LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.PartOptions.Values)
                    {
                        ...
                        Debug.Log("Connect to NCIObject 3 loop pO.OptionID="+pO.OptionID+" pO.isDisabled="+pO.isDisabled);
                    }
...
#region LCARS Connect
            ...
            if (!LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_start_done) 
            {
                ...
                Debug.Log("LCARS_NCI_Mission_Archive_RunningStep processStep step_start for step " + LCARS_NCI_Mission_Archive_Tools.get_current_stepID() + " Job " + LCARS_NCI_Mission_Archive_Tools.get_current_jobID() + "");
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_end_reached = false;
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.job_end_reached = false;
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_conversation_done = false;
            ...
            if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_start_done)
            {
                Debug.Log("LCARS_NCI_Mission_Archive_RunningStep processStep step_start_done=true on to PerformStepTasks for step " + LCARS_NCI_Mission_Archive_Tools.get_current_stepID() + " Job " + LCARS_NCI_Mission_Archive_Tools.get_current_jobID() + "");
                ...
                {
                    Debug.Log("LCARS_NCI_Mission_Archive_RunningStep processStep job_end_reached for step " + LCARS_NCI_Mission_Archive_Tools.get_current_stepID() + " Job " + LCARS_NCI_Mission_Archive_Tools.get_current_jobID() + "");
        ...
        private int LastLogged_Chapter = 0;
        internal void PerformStartStepTasks()
        {
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep PerformStartStepTasks for step " + LCARS_NCI_Mission_Archive_Tools.get_current_stepID() + " Job " + LCARS_NCI_Mission_Archive_Tools.get_current_jobID() + "");


            if (LastLogged_Chapter != LCARS_NCI_Mission_Archive_Tools.get_current_stepID() && LCARS_NCI_Mission_Archive_Tools.get_current_jobID() == 0)
            {
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.progressLog.addItem(
                                LCARS_NCI_Mission_Archive_Tools.getNow(),
                                LCARS_NCI_Mission_Archive_Tools.get_current_stepID(),
                ...
                LastLogged_Chapter = LCARS_NCI_Mission_Archive_Tools.get_current_stepID();
            }
        ...
        string LoopingScreenMessage_text = null;
        internal void PerformStepTasks()
        {
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep PerformStepTasks for step " + LCARS_NCI_Mission_Archive_Tools.get_current_stepID() + " Job " + LCARS_NCI_Mission_Archive_Tools.get_current_jobID() + "");
            ...
            try
            {
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep PerformStepTasks check for Conversation begin  for step " + LCARS_NCI_Mission_Archive_Tools.get_current_stepID() + " Job " + LCARS_NCI_Mission_Archive_Tools.get_current_jobID() + "");
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep PerformStepTasks check for Conversation last_conversation_was_in_step=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.last_conversation_was_in_step);
                
                if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.last_conversation_was_in_step == LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.id)
                {
                    LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_conversation_done = true;
                }
                else
                ...
                {
                    if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.Conversation.SpeechList == null)
                    {
                        LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_conversation_done = true;
                    }
                    else
                ...
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep PerformStepTasks check for Conversation step_conversation_done=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_conversation_done);
                ...
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep PerformStepTasks check for Conversation done show_conversation=" + show_conversation);

                /*if ((LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_conversation_done || LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningConversation.missionConversation == null) && LCARS_NCI.Instance.Data.MissionArchive.RunningMission.current_job == 0)
                {
            ...
            //UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep PerformStepTasks show_conversation=" + show_conversation);
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep PerformStepTasks LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.conditionConfirmedOnce=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.conditionConfirmedOnce);
            //UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep PerformStepTasks LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.checkCondition()=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.checkCondition());
            if (show_conversation && LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.conditionConfirmedOnce)
            {
            ...
            {
                if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningConversation == null || LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_conversation_done)
                {
                    LCARS_NCI.Instance.GUI.Generic.setWindowState(false);
                }
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep PerformStepTasks => RunJobs for step " + LCARS_NCI_Mission_Archive_Tools.get_current_stepID() + " Job " + LCARS_NCI_Mission_Archive_Tools.get_current_jobID() + "");
                RunJobs();
            }

            try
            {
                if ((Time.time - LoopingScreenMessage_lastUpdate) > (LoopingScreenMessage_Interval / Time.deltaTime))
                {
                    ...
                    if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobID > 0)
                    {
                        ...
                        {
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step LoopingScreenMessage loop running L.messageID=" + L.messageID);
                            if (L.step < LCARS_NCI_Mission_Archive_Tools.get_current_stepID() || L.job < LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobID)
                            {
                                ...
                                LoopingScreenMessage_text = null;
                            ...
                            else
                            {
                                ...
                                LoopingScreenMessage_text = LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.steps[L.step].Messages.MessageList[L.messageID].title;
                                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step PerformStepTasks LoopingScreenMessage LoopingScreenMessage_text=" + LoopingScreenMessage_text);
                                if (LoopingScreenMessage_text.Contains("[DISTANCE]"))
                                {
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step PerformStepTasks LoopingScreenMessage LoopingScreenMessage_text contains [DISTANCE]  LoopingScreenMessage_text=" + LoopingScreenMessage_text);
                                    ...
                                    try { requirement_id = (L.message.requirement_id == null) ? 0 : L.message.requirement_id; }
                                    catch { }
                                    try { this_condition_part = (L.message.NCI_object == null) ? "" : L.message.NCI_object; }
                                    catch { }
                                    try { this_condition_egg = (L.message.NCI_egg == null) ? "" : L.message.NCI_egg; }
                                    catch { }
                                    try { this_condition_body = (L.message.NCI_body == null) ? "" : L.message.NCI_body; }
                                    catch { }
                                    try { this_condition_PQSCity = (L.message.NCI_PQSCity == null) ? "" : L.message.NCI_PQSCity; }
                                    catch { }

                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step PerformStepTasks LoopingScreenMessage LoopingScreenMessage stepID=" + stepID);
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step PerformStepTasks LoopingScreenMessage jobID=" + jobID);
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step PerformStepTasks LoopingScreenMessage requirement_id=" + requirement_id);
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step PerformStepTasks LoopingScreenMessage this_condition_part=" + this_condition_part);
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step PerformStepTasks LoopingScreenMessage this_condition_egg=" + this_condition_egg);
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step PerformStepTasks LoopingScreenMessage this_condition_body=" + this_condition_body);
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step PerformStepTasks LoopingScreenMessage this_condition_PQSCity=" + this_condition_PQSCity);

                                    L.contextPosition = Vector3.zero;
                                    float distance = 0f;
                                    try
                                    {
                                        GameObject go_in_question = LCARS_NCI_Mission_Archive_Tools.identify_gameObject(requirement_id, this_condition_part, this_condition_egg, this_condition_body, this_condition_PQSCity, LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission);
                                        L.contextPosition = go_in_question.transform.position;
                                    }
                                    catch {  }
                                    if (L.contextPosition != Vector3.zero)
                                    {
                                        ...
                                        LoopingScreenMessage_text = LoopingScreenMessage_text.Replace("[DISTANCE]", distance + "");
                                    }
                                    else
                                    {
                                        LoopingScreenMessage_text = null;
                                    ...
                                    if (index > 0)
                                    {
                                        ...
                                        if (isCelestialBody)
                                        {
                                            ...
                                            if (StepBody != null)
                                            {
                                                NCIScanGOExtensions.FilterChildGameObjects(StepBody.gameObject, LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.Messages.MessageList[L.messageID].NCI_PQSCity);
                                                Transform tmp = null;
                                                if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.Messages.MessageList[L.messageID].NCI_egg != "")
                                                {
                                                    foreach (KeyValuePair<string, GameObject> pair in NCIScanGOExtensions.ActionPointsGameObjects)
                                                    {
                                                ...
                                                if (tmp != null)
                                                {
                                                    L.contextPosition = tmp.position;
                                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition was found: " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.Messages.MessageList[L.messageID].NCI_egg + " at " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.Messages.MessageList[L.messageID].NCI_body);
                                                }
                                                else
                                                {
                                                    L.contextPosition = StepBody.transform.position;
                                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition was found: NCI_body=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.Messages.MessageList[L.messageID].NCI_body);
                                                }
                                            }
                                        }
                                        else
                                        ...
                                        if (L.contextPosition != Vector3.zero)
                                        {
                                            distance = Vector3.Distance(FlightGlobals.ActiveVessel.CoM, L.contextPosition);
                                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step PerformStepTasks LoopingScreenMessage mR.assigned_sfs_object_Guid found distance=" + distance);
                                            LoopingScreenMessage_text = LoopingScreenMessage_text.Replace("[DISTANCE]", distance + " Meter");
                                        }
                                        else
                                        {
                                            LoopingScreenMessage_text = null;
                                ...
                                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step PerformStepTasks LoopingScreenMessage display message LoopingScreenMessage_text=" + LoopingScreenMessage_text);
                            }
                            if (LoopingScreenMessage_text != null)
                            {
                                ScreenMessages.PostScreenMessage(
                                    "<color=#ff9900ff>LoopingScreenMessage: " + LoopingScreenMessage_text + "</color>",
        ...
        {
            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningStep RunConversation begin  for step " + LCARS_NCI_Mission_Archive_Tools.get_current_stepID() + " Job " + LCARS_NCI_Mission_Archive_Tools.get_current_jobID() + "");
            if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.last_conversation_was_in_step == LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.id)
            {
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_conversation_done = true;
            }
            ...
            if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_conversation_done)
            {
                //LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningConversation.oldWindowState = true;
            ...
            if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.Conversation.SpeechList != null && LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.Conversation.SpeechList.Count>=1)
            {
                ...
                {
                    LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningConversation.oldWindowState = false;
                    LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningConversation.WindowState = true;
                }*/
        ...
        {
            UnityEngine.Debug.Log("### RunJobs begin ");
            if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.current_job < 1) 
            {
                UnityEngine.Debug.Log("### RunJobs current_job < 1 correcting ");
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.current_job = 1;
            }
            UnityEngine.Debug.Log("### RunJobs current_job=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.current_job);

            if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep == null) { UnityEngine.Debug.Log("### RunJobs no missionStep aborting"); return; }
            if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob == null)
            {
                UnityEngine.Debug.Log("### RunJobs create new RunningJob ");
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob = new LCARS_NCI_Mission_Archive_RunningJob();
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_end_reached = false;
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.job_end_reached = false;
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.job_start_done = false;
            ...
            catch (Exception ex) { UnityEngine.Debug.Log("### RunJobs test jobList failed ex="+ex); }
            ...
            {
                UnityEngine.Debug.Log("### RunJobs PerformStartJobTasks ");
            ...
            {
                UnityEngine.Debug.Log("### RunJobs job_end_reached");
            ...
            if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.job_end_reached)
            {
                UnityEngine.Debug.Log("### RunJobs PerformEndJobTasks ");
                ...
                {
                    UnityEngine.Debug.Log("### RunJobs RunningJob.missionJob.isStepEnd ");
                    LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_end_reached = true;
                }
                UnityEngine.Debug.Log("### RunJobs go_to_next_Job ");
            ...
            UnityEngine.Debug.Log("### RunJobs done ");
    ...
    {
        public LCARS_NCI_Mission mission { set; get; }
        public string mission_name { set; get; } //{ get { return mission.title;  } }
        public string missionGuid { set; get; }
        ...
        public bool saveMissionLog()
        {
            ...
            Debug.Log("LCARS_NCI_MissionProgressLog saveMissionLog 1 missionCFG_path=" + missionCFG_path);
            ...
            {
                MissionLog = new ConfigNode("root");
                MISSIONPROGRESSLOG = new ConfigNode("MISSIONPROGRESSLOG");
                MISSIONPROGRESSLOG.AddNode(MissionLog);
                Debug.Log("LCARS_NCI_MissionProgressLog saveMissionLog 4b failed ");
            }
    ...
    public class LCARS_NCI_Mission_Archive_RunningConversation
    {
        ...
        // invokes the GenereicGUI from NCI to display the ConversationGUI() 
        ...
        public void ConversationGUI()
        {
            ...
            if (scrollview_style1 == null)
            {
                ...
                scrollview_style1.fixedHeight = 210;
            }
            if (scrollview_style2 == null)
            {
                scrollview_style2 = new GUIStyle();
                scrollview_style2.fixedHeight = 140;
            }
            LCARS_NCI_Personality P = null;
            try
            {
                P = LCARS_NCI.Instance.Data.Personalities.list[LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningConversation.missionConversation.personality];
            }
            catch { }
            if (P==null) 
            {
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningConversation ConversationGUI failed, no personality, closing window now ");
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningConversation.WindowState = false;
                LCARS_NCI.Instance.GUI.Generic.setWindowState(false);
                return; 
            }
            ...
            GUILayout.Label("NCI Conversation - You are talking to:");
            GUILayout.Label(P.name + " - " + P.description);
            ...
            GUILayout.BeginHorizontal(GUILayout.Height(370), GUILayout.Width(670));
                ...
                GUILayout.BeginVertical(GUILayout.Height(364), GUILayout.Width(331));
                    GUILayout.BeginVertical(scrollview_style1);
                    ...
                    if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningConversation.current_speechID >= 1)
                    {
                        UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningConversation ConversationGUI RunningMission=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.title);
                        UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningConversation ConversationGUI RunningStep=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.id);
                        //UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningConversation ConversationGUI RunningJob=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.id);
                        ...
                        if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningConversation.current_speechID != oldspeechID)
                        {
                            ...
                            if (Speech.reward_player)
                            {
                                ...
                                {
                                    Debug.Log("LCARS_NCI_Mission_Archive_RunningConversation Speech.reward_cash Testing ");
                                    string response_task = "";
                                    try
                                    {
                                        Funding.Instance.AddFunds(-1 * LCARS_NCI_Mission_Archive_Tools.ToFloat(Speech.reward_cash), TransactionReasons.None);
                                        response_task = P.name+" gave you " + Speech.reward_cash + " funds.";
                                        LCARS_NCI.Instance.Data.MissionArchive.RunningMission.progressLog.addItem(
                                                    LCARS_NCI_Mission_Archive_Tools.getNow(),
                                                    LCARS_NCI_Mission_Archive_Tools.get_current_stepID(),
                                                    LCARS_NCI_Mission_Archive_Tools.get_current_jobID(),
                                        ...
                                        ScreenMessages.PostScreenMessage(
                                            "<color=#ff9900ff>You received Cash: " + response_task + "</color>",
                                            5f, ScreenMessageStyle.UPPER_CENTER
                                        );
                                    }
                                    catch 
                                    {
                                        ...
                                        LCARS_NCI.Instance.Data.MissionArchive.RunningMission.progressLog.addItem(
                                                    ...
                                                    LCARS_NCI_Mission_Archive_Tools.get_current_stepID(),
                                                    LCARS_NCI_Mission_Archive_Tools.get_current_jobID(),
                                                    "Cash ERROR - are you in SandBox?",
                                                    response_task
                                                );
                                        ScreenMessages.PostScreenMessage(
                                            "<color=#ff9900ff>Cash ERROR - are you in SandBox?</color>",
                                            5f, ScreenMessageStyle.UPPER_CENTER
                                        );
                                    }
                                }
                                ...
                                {
                                    Debug.Log("LCARS_NCI_Mission_Archive_RunningConversation Speech.reward_reputation TODO");
                                    ScreenMessages.PostScreenMessage(
                                        "<color=#ff9900ff>Reputation ERROR - reward_reputation TODO</color>",
                                        5f, ScreenMessageStyle.UPPER_CENTER
                                    );
                                }
                                if (Speech.reward_science != "")
                                {
                                    Debug.Log("LCARS_NCI_Mission_Archive_RunningConversation Speech.reward_science TODO");
                                    ScreenMessages.PostScreenMessage(
                                        "<color=#ff9900ff>Science ERROR - reward_science TODO</color>",
                                        5f, ScreenMessageStyle.UPPER_CENTER
                                    );
                                }
                            }
                            ...
                            LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.send_message(LCARS_NCI_Mission_Archive_Tools.ToInt(Speech.speechStart_messageID_email));
                            LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.send_message(LCARS_NCI_Mission_Archive_Tools.ToInt(Speech.speechStart_messageID_console));
                            LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.send_message(LCARS_NCI_Mission_Archive_Tools.ToInt(Speech.speechStart_messageID_screen));
                        ...
                        foreach (LCARS_NCI_Mission_Speech_Respons R in Speech.ResponsList)
                        {
                            ...
                            {
                                bool run_function_go_to_next_Step = false;
                                Debug.Log("LCARS_NCI_Mission_Archive_RunningConversation reply button clicked: begin ");
                                string response_task = "";
                                switch(R.responsEvent)
                                {
                                    ...
                                    case "closeWindow":
                                        LCARS_NCI.Instance.Data.MissionArchive.RunningMission.step_conversation_done = true;
                                        LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningConversation.WindowState = false;
                                        LCARS_NCI.Instance.GUI.Generic.setWindowState(LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningConversation.WindowState);
                                        //LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningConversation = null;
                                        response_task = " go to step " + R.responsStepID + " and the conversation ended.";
                                        run_function_go_to_next_Step = true;
                                        LCARS_NCI.Instance.Data.MissionArchive.RunningMission.last_conversation_was_in_step = LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.id;
                                        break;
                                    ...
                                    case "giveCash":
                                        LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningConversation.current_speechID = LCARS_NCI_Mission_Archive_Tools.ToInt(R.responsTextID);
                                        Funding.Instance.AddFunds(-1 * LCARS_NCI_Mission_Archive_Tools.ToFloat(R.responsCashAmount), TransactionReasons.None);
                                        response_task = "You gave " + R.responsCashAmount + " funds to " + P.name + " and the conversation continued with speech " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningConversation.current_speechID + ".";
                                        break;
                                }
                                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.progressLog.addItem(
                                            LCARS_NCI_Mission_Archive_Tools.getNow(),
                                ...
                                Debug.Log("LCARS_NCI_Mission_Archive_RunningConversation reply button clicked: R.responsText=" + R.responsText);
                                if (run_function_go_to_next_Step)
                                {
    ...
    public class LCARS_NCI_Mission_Archive_RunningJob
    {
        ...
        public bool checkCondition()
        {
            ...
            if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype == "distanceLower" ||
                ...
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype == "scan")
            {
                ...
                */
                if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.requirements.list.ContainsKey(LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.requirement_id))
                {
                    mR = LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.requirements.list[LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.requirement_id];
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " mR mR.id=" + mR.id);
                }
                else
                {
            ...
            switch (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype)
            {
                ...
                case"distanceLower":
                case "distanceGreater":
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob " + sID + "/" + jID + " checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype);


                    return_bool = LCARS_NCI_Mission_Archive_Tools.checkCondition_Distance_Job(LCARS_NCI_Mission_Archive_Tools.get_current_stepID(), LCARS_NCI_Mission_Archive_Tools.get_current_jobID(), LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission);
                    ...
                    if (isCelestialBody)
                    {
                        ...
                        NCIScanGOExtensions.FilterChildGameObjects(StepBody.gameObject, LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_PQSCity);
                        Transform tmp = null;
                        if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_egg != "")
                        {
                            ...
                            {
                                string name = pair.Value.name;
                                if (name == LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_egg)
                                {
                                    GameObject go = pair.Value;
                                    tmp = go.transform;
                                }
                        ...
                        {
                            messure_point = tmp.position;
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition was found: " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_egg + " at " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_PQSCity + " on " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_body);
                        }
                        else
                        {
                            messure_point = StepBody.transform.position;
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition was found: " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_body);
                        }
                    ...
                    else
                    {
                        foreach (Vessel v in FlightGlobals.Vessels)
                        {
                            ...
                            if (v.rootPart.name.Contains(LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_object) && mR.assigned_sfs_object_Guid == v.id && v.loaded)
                            {
                                Transform tmp = null;
                                if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_egg != "")
                                {
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " FindModelTransform v.vesselName=" + v.vesselName);
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " FindModelTransform v.id=" + v.id);
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " FindModelTransform NCI_egg=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_egg);
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " FindModelTransform mR.assigned_sfs_object_Guid=" + mR.assigned_sfs_object_Guid);
                                ...
                                if (tmp != null)
                                {
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " tmp != null transform.position v.vesselName=" + v.vesselName);
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " tmp != null transform.position v.id=" + v.id);
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " tmp != null transform.position NCI_object=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_object);
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " tmp != null transform.position mR.assigned_sfs_object_Guid=" + mR.assigned_sfs_object_Guid);
                                    messure_point = tmp.transform.position;
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " messure_point was found: " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_egg + " at " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_object + " " + mR.assigned_sfs_object_Guid);
                                }
                                else
                                {
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " else transform.position v.vesselName=" + v.vesselName);
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " else transform.position v.id=" + v.id);
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " else transform.position NCI_object=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_object);
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " else transform.position mR.assigned_sfs_object_Guid=" + mR.assigned_sfs_object_Guid);
                                    messure_point = v.transform.position;
                                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " messure_point was found: " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_object + " " + mR.assigned_sfs_object_Guid);
                                }
                            }
                    ...
                    if (messure_point == Vector3.zero)
                    {
                        UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " messure_point was NOT found skipping");
                        return_bool = false;

                        //UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype+" attempting to fix the problem now");
                        //LCARS_NCI.Instance.Data.MissionArchive.Assigne_MissionObjectsToSFSObjects(LCARS_NCI_Object_assigned_missions this_aM)
                    ...
                    if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype == "distanceLower")
                    {
                        ...
                        {
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " was met: missionJob.distance=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.distance);
                            return_bool = true;
                        }
                        else 
                        {
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob checkCondition " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype + " was NOT met: missionJob.distance=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.distance);
                            return_bool = false;
                        }
                    }
                    if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobtype == "distanceGreater")
                    {
                ...
                case"scan":
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob " + sID + "/" + jID + " checkCondition scan");
                    try
                    {
                        Guid guid = mR.assigned_sfs_object_Guid;
                        string idcode = mR.part_idcode;
                        float distance = LCARS_NCI_Mission_Archive_Tools.ToFloat(LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.distance);
                        if (LCARSNCI_Bridge.Instance.validate_LCARS_Scan(guid, idcode, distance))
                        {
                            return_bool = true;
                        }
                        else
                ...
                case "drop":
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Archive_RunningJob " + sID + "/" + jID + " checkCondition drop");
                    try
                    {
                        if(LCARSNCI_Bridge.Instance.takeArtefactFromPlayer(LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_artefact))
                        {
                            Debug.Log("LCARS_NCI_Mission_Archive_RunningJob checkCondition drop takeArtefactFromPlayer done");
                            return_bool = true;
                            ScreenMessages.PostScreenMessage(
                                "<color=#ff9900ff>You have dropped the artefact: " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_artefact + "</color>",
                                5f, ScreenMessageStyle.UPPER_CENTER
                            );
                        }
                        else
                        {
                            Debug.Log("LCARS_NCI_Mission_Archive_RunningJob checkCondition drop takeArtefactFromPlayer failed");
                            return_bool = false;
                        }
                    }
                    catch (Exception ex)
                    {
                        Debug.Log("LCARS_NCI_Mission_Archive_RunningJob checkCondition drop takeArtefactFromPlayer now failed ex=" + ex);
                        return_bool = false;
                    }
                    break;
                ...
                case "collect":
                    ...
                    try
                    {
                        if(LCARSNCI_Bridge.Instance.giveArtefactToPlayer(LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_artefact))
                        {
                            Debug.Log("LCARS_NCI_Mission_Archive_RunningJob checkCondition collect giveArtefactToPlayer done");
                            return_bool = true;
                            ScreenMessages.PostScreenMessage(
                                "<color=#ff9900ff>You have picked up the artefact: " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.NCI_artefact + "</color>",
                                5f, ScreenMessageStyle.UPPER_CENTER
                            );
                        }
                        else
                        {
                            Debug.Log("LCARS_NCI_Mission_Archive_RunningJob checkCondition collect giveArtefactToPlayer failed");
                            return_bool = false;
                        }
                    }
                    catch (Exception ex)
