...
namespace LCARSMarkII
{
    ...
    public class LCARS_NCI_Mission
    {
        ...
        public void addRequirement(LCARS_NCI_Object NCI_Object)
        {
            ...
            p.isCelestialBody = NCI_Object.isCelestialBody;
            p.Locations = NCI_Object.Locations;
            p.bodyname = NCI_Object.bodyname;
        ...
        */
        ...
        public bool meetsRequirements()
        {
            ...
            */
            ...
            string foo = "";
            if(req_count >= requirements.list.Count)
            {
                foo = " True ";
            }
            else
            ...
            UnityEngine.Debug.Log("LCARS_NCI_Mission meetsRequirements: Does the Save meet the requirements (" + requirements.list.Count + ") for " + this.title + "=" + foo);
            ...
            switch (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.steps[currentStep].Messages.MessageList[messageID].messageType)
            {
                ...
                case "console":
                    ...
                    else
                    {
                        ...
                        try { requirement_id = (message.requirement_id == null) ? 0 : message.requirement_id; }
                        catch { }
                        try { this_condition_part = (message.NCI_object == null) ? "" : message.NCI_object; }
                        catch { }
                        try { this_condition_egg = (message.NCI_egg == null) ? "" : message.NCI_egg; }
                        catch { }
                        try { this_condition_body = (message.NCI_body == null) ? "" : message.NCI_body; }
                        catch { }
                        try { this_condition_PQSCity = (message.NCI_PQSCity == null) ? "" : message.NCI_PQSCity; }
                        catch { }

                        UnityEngine.Debug.Log("### LCARS_NCI_Mission  send_message NCIConsole.list LoopingScreenMessage LoopingScreenMessage stepID=" + stepID);
                        UnityEngine.Debug.Log("### LCARS_NCI_Mission  send_message NCIConsole.list LoopingScreenMessage jobID=" + jobID);
                        UnityEngine.Debug.Log("### LCARS_NCI_Mission  send_message NCIConsole.list LoopingScreenMessage requirement_id=" + requirement_id);
                        UnityEngine.Debug.Log("### LCARS_NCI_Mission  send_message NCIConsole.list LoopingScreenMessage this_condition_part=" + this_condition_part);
                        UnityEngine.Debug.Log("### LCARS_NCI_Mission  send_message NCIConsole.list LoopingScreenMessage this_condition_egg=" + this_condition_egg);
                        UnityEngine.Debug.Log("### LCARS_NCI_Mission  send_message NCIConsole.list LoopingScreenMessage this_condition_body=" + this_condition_body);
                        UnityEngine.Debug.Log("### LCARS_NCI_Mission  send_message NCIConsole.list LoopingScreenMessage this_condition_PQSCity=" + this_condition_PQSCity);

                        Vector3 contextPosition = Vector3.zero;
                        float distance = 0f;
                        try
                        {
                            ...
                            contextPosition = go_in_question.transform.position;
                        }
                        catch { }
                        string NCIConsoleMessage_text = "";
                        if (contextPosition != Vector3.zero)
                        {
                            NCIConsoleMessage_text = LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.steps[currentStep].Messages.MessageList[messageID].title;
                            distance = Vector3.Distance(FlightGlobals.ActiveVessel.CoM, contextPosition);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission  send_message NCIConsole.list mR.assigned_sfs_object_Guid found distance=" + distance);
                            NCIConsoleMessage_text = NCIConsoleMessage_text.Replace("[DISTANCE]", distance + "");
                        }
                        else
                        {
                            NCIConsoleMessage_text = "";
                        }
                        if (contextPosition != Vector3.zero)
                        {
                            if (LCARS_NCI.Instance.Data.NCIConsole == null)
                            ...
                            LCARS_NCI.Instance.Data.NCIConsole.list.Add(NCIConsoleMessage_text);
                ...
                case "screen":
                    ...
                    if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.steps[currentStep].Messages.MessageList[messageID].loopMessage)
                    {
                        ...
                        tmp.message = LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.steps[currentStep].Messages.MessageList[messageID];
                        tmp.messageID = messageID;
                        tmp.step = (from_StepID == 0) ? LCARS_NCI_Mission_Archive_Tools.get_current_stepID() : from_StepID;
                        tmp.job = LCARS_NCI_Mission_Archive_Tools.get_current_jobID();
                        tmp.contextTransform = null;
                    ...
                    {
                        string SingleScreenMessage_text = LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.steps[currentStep].Messages.MessageList[messageID].title;
                        if (SingleScreenMessage_text.Contains("[DISTANCE]"))
                        {
                            LCARS_NCI_Mission_Message message = LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.steps[currentStep].Messages.MessageList[messageID];
                            int requirement_id = 0;
                            string this_condition_part = "";
                            ...
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission  send_message SingleScreenMessage LoopingScreenMessage stepID=" + stepID);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission  send_message SingleScreenMessage jobID=" + jobID);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission  send_message SingleScreenMessage requirement_id=" + requirement_id);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission  send_message SingleScreenMessage this_condition_part=" + this_condition_part);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission  send_message SingleScreenMessage this_condition_egg=" + this_condition_egg);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission  send_message SingleScreenMessage this_condition_body=" + this_condition_body);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission  send_message SingleScreenMessage this_condition_PQSCity=" + this_condition_PQSCity);
                            ...
                            {
                                distance = Vector3.Distance(FlightGlobals.ActiveVessel.CoM, contextPosition);
                                UnityEngine.Debug.Log("### LCARS_NCI_Mission  send_message SingleScreenMessage mR.assigned_sfs_object_Guid found distance=" + distance);
                                SingleScreenMessage_text = SingleScreenMessage_text.Replace("[DISTANCE]", distance + "");
                            }
                            else
                            {
                                SingleScreenMessage_text = "";
                            }
                        ...
                        if (SingleScreenMessage_text != "")
                        {
                            ScreenMessages.PostScreenMessage(
                                   "<color=#ff9900ff>SingleScreenMessage: " + SingleScreenMessage_text + "</color>",
    ...
    public class LoopingScreenMessage
    {
        ...
        public LCARS_NCI_Mission_Message message { get; set; }
    }
    ...
    public class LCARS_NCI_Mission_Requirement
    {
        ...
        public bool isCelestialBody { set; get; }
    ...
    public class LCARS_NCI_Mission_Step
    {
        ...
        public string location_body { set; get; }
        public string location_PQSCity { set; get; }
       ...
       /*
        public bool checkCondition()
        {
                ...
                LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.locationtype == "distanceGreater")
            {
                ...
                int index = LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.requirementPart_id;
                ...
                try
                {
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition: mission =" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.title);
                }
                catch { }
                try
                {
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition: step =" + LCARSNCI_Bridge.Instance.getCurrentStepID());
                }
                catch { }
                try
                {
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition: Job =" + LCARSNCI_Bridge.Instance.getCurrentJobID());
                }
                catch { }
                try
                {
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition: Condition Part =" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.location_part);
                }
                catch { }
                try
                {
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition: location_egg=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.location_egg );
                }
                catch{}
            }

            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition requierment found, now looking for GUID ");
            ...
            if (isCelestialBody)
            {
                ...
                NCIScanGOExtensions.FilterChildGameObjects(StepBody.gameObject, LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.location_PQSCity);
                Transform tmp = null;
                ...
                if (tmp != null)
                {
                    ...
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition was found: " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.location_egg + " at " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.location_PQSCity + " on " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.location_body);
                }
                else
                {
                    messure_point = StepBody.transform.position;
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition was found: location_body=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.location_body);
                }
            ...
            else
            {
                ...
                {
                    if (!v.loaded)
                    { UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition v.loaded==false;  skipping vessel " + v.name + " v.id=" + v.id + " "); continue; }

                    if (v.mainBody != FlightGlobals.ActiveVessel.mainBody)
                    { UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition v.mainBody != FlightGlobals.ActiveVessel.mainBody skipping vessel " + v.name + " v.id=" + v.id + " "); continue; }

                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition locationdistance=" + locationdistance + " loop start for vessel " + v.name + " v.id=" + v.id + " mR.assigned_sfs_object_Guid=" + mR.assigned_sfs_object_Guid);
                    try
                    {
                        UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition locationdistance=" + locationdistance + " mR.part_idcode=" + mR.part_idcode + " mR.egg_idcode=" + mR.egg_idcode + " requirements.list assigned_sfs_object_Guid=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.requirements.list[LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.requirementPart_id].assigned_sfs_object_Guid + " v.id=" + v.id + " vessel " + v.name);
                    }
                    catch { }

                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition loop 1 v.loaded=" + v.loaded + " for v.id=" + v.id + " v.vesselName=" + v.vesselName);
                    if (v.id == FlightGlobals.ActiveVessel.id)
                    {
                        UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition v.id == FlightGlobals.ActiveVessel.id skipping vessel " + v.name + " ");
                        continue;
                    }
                    ...
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition loop v.rootPart.name=" + v.rootPart.name);
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition loop missionStep.location_part=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.location_part);
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition loop mR.assigned_sfs_object_Guid=" + mR.assigned_sfs_object_Guid);
                    UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition loop v.id=" + v.id);
                    ...
                    if (v.rootPart.name.Contains(LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.location_part) && mR.assigned_sfs_object_Guid == v.id)
                    {
                        ...
                        if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.location_egg != "")
                        {
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition loop 5 find " + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.location_egg);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition FindModelTransform v.vesselName=" + v.vesselName);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition FindModelTransform v.id=" + v.id);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition FindModelTransform NCI_egg=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.location_egg);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition FindModelTransform mR.assigned_sfs_object_Guid=" + mR.assigned_sfs_object_Guid);
                        ...
                        if (tmp != null)
                        {
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition tmp != null transform.position v.vesselName=" + v.vesselName);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition tmp != null transform.position v.id=" + v.id);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition tmp != null transform.position NCI_object=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.location_part);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition tmp != null transform.position mR.assigned_sfs_object_Guid=" + mR.assigned_sfs_object_Guid);
                            messure_point = tmp.position;
                        ...
                        {
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition else transform.position v.vesselName=" + v.vesselName);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition else transform.position v.id=" + v.id);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition else transform.position NCI_object=" + LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.missionStep.location_part);
                            UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition else transform.position mR.assigned_sfs_object_Guid=" + mR.assigned_sfs_object_Guid);
                ...
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition requiement found, search for GUID has ended ");
            }
            ...
            {
                UnityEngine.Debug.Log("### LCARS_NCI_Mission_Step checkCondition for step " + LCARS_NCI_Mission_Archive_Tools.get_current_stepID() + " Job " + LCARS_NCI_Mission_Archive_Tools.get_current_jobID() + "");
    ...
    */
    ...
    public class LCARS_NCI_Mission_Message
    {
        ...
        public int requirement_id { get; set; } //requirement ID, body name,
        public string NCI_body { get; set; }
        public string NCI_PQSCity { get; set; }
    ...
    public class LCARS_NCI_Mission_Job
    {
        ...
        public int requirement_id { get; set; } //requirement ID, body name,
        public string NCI_body { get; set; } //requirement ID, body name,
        public string NCI_PQSCity { get; set; }
