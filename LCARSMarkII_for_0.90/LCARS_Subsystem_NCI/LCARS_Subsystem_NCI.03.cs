                            ...
                            if (LCARS_NCI.Instance.Data.MissionArchive.RunningMission.RunningStep.RunningJob.missionJob.jobID > 0)
                            {
                                foreach (LoopingConsoleMessage L in LCARS_NCI.Instance.Data.NCIConsole.looplist)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        LCARS_NCI_Mission_Message message = LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.steps[L.step].Messages.MessageList[L.messageID];
                                        int requirement_id = 0;
                                        string this_condition_part = "";
                                        string this_condition_egg = "";
                                        string this_condition_body = "";
                                        ...
                                        UnityEngine.Debug.Log("### LCARS_Subsystem_NCI NCIConsole.looplist LoopingScreenMessage LoopingScreenMessage stepID=" + stepID);
                                        UnityEngine.Debug.Log("### LCARS_Subsystem_NCI NCIConsole.looplist LoopingScreenMessage jobID=" + jobID);
                                        UnityEngine.Debug.Log("### LCARS_Subsystem_NCI NCIConsole.looplist LoopingScreenMessage requirement_id=" + requirement_id);
                                        UnityEngine.Debug.Log("### LCARS_Subsystem_NCI NCIConsole.looplist LoopingScreenMessage this_condition_part=" + this_condition_part);
                                        UnityEngine.Debug.Log("### LCARS_Subsystem_NCI NCIConsole.looplist LoopingScreenMessage this_condition_egg=" + this_condition_egg);
                                        UnityEngine.Debug.Log("### LCARS_Subsystem_NCI NCIConsole.looplist LoopingScreenMessage this_condition_body=" + this_condition_body);
                                        UnityEngine.Debug.Log("### LCARS_Subsystem_NCI NCIConsole.looplist LoopingScreenMessage this_condition_PQSCity=" + this_condition_PQSCity);
                                        ...
                                        {
                                            NCIConsoleMessage_text = LCARS_NCI.Instance.Data.MissionArchive.RunningMission.mission.steps[L.step].Messages.MessageList[L.messageID].title;
                                        ...
                                        if (contextPosition != Vector3.zero)
                                        {
                                            looplist_compiled.Add(NCIConsoleMessage_text);
                                            Debug.Log("LCARS_Subsystem_NCI NCIConsole.looplist done  list.Count=" + LCARS_NCI.Instance.Data.NCIConsole.list.Count);
                                        }
                                        /*
