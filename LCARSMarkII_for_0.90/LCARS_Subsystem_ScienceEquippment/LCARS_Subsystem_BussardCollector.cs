...
namespace LCARSMarkII
{
    ...
    public class LCARS_Subsystem_BussardCollector : ILCARSPlugin
    {
        ...
        public void SetVessel(Vessel vessel)
        {
            ...
            if (LCARS.lODN.ShipSystems.ContainsKey("Bussard Collector"))
            {
                LCARS.lODN.ShipSystems["Bussard Collector"].disabled = true;
            }
        }
